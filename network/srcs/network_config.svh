...
localparam isFC_list_3_5[`CN] = '{1,0,0,0,0};
...
localparam isFC_list_4_2[`CN] = '{1,0,0,0,0};
localparam isFC_list_4_3[`CN] = '{0,0,0,0,0};
localparam isFC_list_4_4[`CN] = '{1,0,0,0,0};
...
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_0_4[`CN] = '{56'b00000000000000110000000110000000000000000000000000000000,56'b0,56'b0,56'b0,56'b0};
...
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_2_1[`CN] = '{56'b00000000000000000000000000000000000001100100000010000000,56'b0,56'b0,56'b0,56'b0};
...
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_2_6[`CN] = '{56'b10010001100000000000000000000000000000000000000000000000,56'b0,56'b0,56'b0,56'b0};
...
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_3_1[`CN] = '{56'b0,56'b0,56'b0,56'b0,56'b0};
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_3_2[`CN] = '{56'b0,56'b0,56'b0,56'b0,56'b0};
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_3_3[`CN] = '{56'b00000000000000000000011001100000000000000000000000000000,56'b0,56'b0,56'b0,56'b0};
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_3_4[`CN] = '{56'b0,56'b0,56'b0,56'b0,56'b0};
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_3_5[`CN] = '{56'b01100000011000000000000000000000000000000000000000000000,56'b0,56'b0,56'b0,56'b0};
...
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_4_1[`CN] = '{56'b00000000000000000000000000000000000110011000000000000000,56'b0,56'b0,56'b0,56'b0};
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_4_2[`CN] = '{56'b00000000000000000000000000010110010000000000000000000000,56'b0,56'b0,56'b0,56'b0};
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_4_3[`CN] = '{56'b0,56'b0,56'b0,56'b0,56'b0};
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_4_4[`CN] = '{56'b00000000000011001010000000000000000000000000000000000000,56'b0,56'b0,56'b0,56'b0};
...
localparam [`NOC_WIDTH*`NOC_HEIGHT-1:0] FCdn_list_5_5[`CN] = '{56'b00000000000100000101100000000000000000000000000000000000,56'b0,56'b0,56'b0,56'b0};
...
localparam int FCpl_list_3_5[`CN] = '{`PKT_LEN,0,0,0,0};
...
localparam int FCpl_list_4_2[`CN] = '{`PKT_LEN,0,0,0,0};
localparam int FCpl_list_4_3[`CN] = '{0,0,0,0,0};
localparam int FCpl_list_4_4[`CN] = '{`PKT_LEN,0,0,0,0};
...
localparam int FCpl_list_5_1[`CN] = '{`PKT_LEN,0,0,0,0};
...
localparam input_mask_0_2 = 5'b01100;
...
localparam output_sel_1_2 = 5'b00010;
...
localparam input_mask_3_6 = 5'b00100;
localparam output_sel_3_6 = 5'b00001;
...
localparam input_mask_4_6 = 5'b00101;
...
localparam input_mask_5_4 = 5'b00101;
localparam output_sel_5_4 = 5'b10000;
localparam input_mask_5_5 = 5'b01100;
localparam output_sel_5_5 = 5'b00001;
localparam input_mask_5_6 = 5'b00101;
localparam output_sel_5_6 = 5'b00010;
...
localparam output_sel_6_4 = 5'b00010;
localparam input_mask_6_5 = 5'b00001;
localparam output_sel_6_5 = 5'b00010;
localparam input_mask_6_6 = 5'b00001;
localparam output_sel_6_6 = 5'b00010;
...
localparam stream_id_3_5 = 16;
localparam isCaster_3_6 = 1;
localparam stream_id_3_6 = 1022;

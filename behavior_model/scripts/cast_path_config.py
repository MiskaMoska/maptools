...
'''
W = 5 #cast network width
H = 11 #cast network height
...
# PATH_DICT[(2,4)] = [(1,2,13),(3,0,12),(2,1,14)]
...
# test no contention
PATH_DICT[(0, 0)]=[(1,0,1023), (0, 2, 1)]
PATH_DICT[(0, 1)]=[(2, 3, 7), (2, 0, 7)]
PATH_DICT[(0, 2)]=[(3, 0, 7), (0, 4, 8)]
PATH_DICT[(0, 3)]=[(4, 4, 8), (4, 2, 8), (4, 0, 8)]
PATH_DICT[(0, 4)]=[(4, 0, 8), (0, 4, 11), (0, 2, 11)]
PATH_DICT[(0, 5)]=[(4, 2, 11), (2, 0, 12)]
PATH_DICT[(0, 6)]=[(2, 0, 13)]
PATH_DICT[(0, 7)]=[(2, 0, 15)]
PATH_DICT[(0, 8)]=[(2, 0, 14), (0, 4, 16), (0, 2, 16)]
PATH_DICT[(0, 9)]=[(4, 4, 16), (4, 0, 16)]
PATH_DICT[(0, 10)]=[(4, 0, 16)]
PATH_DICT[(1, 0)]=[(1, 0, 1), (0, 2, 2)]
PATH_DICT[(1, 1)]=[(2, 0, 6), (0, 4, 7), (0, 1, 7)]
PATH_DICT[(1, 2)]=[(4, 2, 7), (4, 0, 7)]
PATH_DICT[(1, 3)]=[(1, 2, 8), (2, 0, 9)]
PATH_DICT[(1, 4)]=[(1, 2, 11), (1, 0, 11), (2, 3, 12)]
PATH_DICT[(1, 5)]=[(1, 2, 11), (1, 0, 11), (3, 1, 12), (3, 3, 12), (0, 4, 13)]
PATH_DICT[(1, 6)]=[(3, 0, 12), (4, 2, 13), (4, 1, 13), (2, 3, 14)]
PATH_DICT[(1, 7)]=[(3, 0, 14), (2, 1, 15)]
PATH_DICT[(1, 8)]=[(2, 1, 14), (2, 0, 14), (1, 4, 16)]
PATH_DICT[(1, 9)]=[(0,1,1022), (4, 2, 16), (2, 3, 17), (2, 0, 17)]
PATH_DICT[(1, 10)]=[(3, 0, 17)]
PATH_DICT[(2, 0)]=[(1, 0, 2), (0, 2, 3)]
PATH_DICT[(2, 1)]=[(2, 1, 6), (2, 0, 6)]
PATH_DICT[(2, 2)]=[(1, 0, 7), (0, 4, 9), (0, 2, 9)]
PATH_DICT[(2, 3)]=[(1, 2, 8), (4, 1, 9), (4, 0, 9), (2, 3, 10)]
PATH_DICT[(2, 4)]=[(3, 0, 10), (1, 2, 11), (2, 1, 12)]
PATH_DICT[(2, 5)]=[(1, 0, 11)]
PATH_DICT[(2, 6)]=[(1, 2, 13), (1, 0, 13), (0, 4, 14), (0, 1, 14)]
PATH_DICT[(2, 7)]=[(4, 4, 14), (2, 1, 15), (2, 0, 15)]
PATH_DICT[(2, 8)]=[(4, 1, 14), (4, 0, 14)]
PATH_DICT[(2, 9)]=[(1, 2, 16), (1, 0, 16), (2, 1, 17)]
PATH_DICT[(2, 10)]=[(0,3,1022), (2, 0, 17)]
PATH_DICT[(3, 0)]=[(1, 0, 3), (0, 2, 4)]
PATH_DICT[(3, 1)]=[(2, 0, 5), (0, 1, 6)]
PATH_DICT[(3, 2)]=[(1, 2, 9), (1, 0, 9)]
PATH_DICT[(3, 3)]=[(1, 2, 8), (1, 0, 8), (0, 1, 10), (0, 4, 10)]
PATH_DICT[(3, 4)]=[(4, 4, 10), (4, 2, 10), (1, 0, 11), (2, 1, 12)]
PATH_DICT[(3, 5)]=[(4, 2, 10), (4, 0, 10)]
PATH_DICT[(3, 6)]=[(1, 4, 13), (1, 0, 13)]
PATH_DICT[(3, 7)]=[(4, 0, 13), (0, 4, 15), (0, 1, 15)]
PATH_DICT[(3, 8)]=[(4, 2, 15), (4, 0, 15)]
PATH_DICT[(3, 9)]=[(1, 2, 16), (2, 1, 17), (2, 0, 17)]
PATH_DICT[(3, 10)]=[(2, 1, 17)]
PATH_DICT[(4, 0)]=[(1, 0, 4), (0, 4, 5)]
PATH_DICT[(4, 1)]=[(4, 1, 5), (4, 0, 5)]
PATH_DICT[(4, 2)]=[(1, 0, 9)]
PATH_DICT[(4, 3)]=[(1, 0, 8)]
PATH_DICT[(4, 4)]=[(1, 0, 10), (0, 4, 12), (0, 1, 12)]
PATH_DICT[(4, 5)]=[(1, 0, 10), (4, 4, 12)]
PATH_DICT[(4, 6)]=[(4, 4, 12), (4, 0, 12)]
PATH_DICT[(4, 7)]=[(4, 0, 12)]
PATH_DICT[(4, 8)]=[(1, 0, 15), (0, 4, 17)]
PATH_DICT[(4, 9)]=[(1, 0, 16), (4, 1, 17), (4, 4, 17)]
PATH_DICT[(4, 10)]=[(4, 1, 17)]

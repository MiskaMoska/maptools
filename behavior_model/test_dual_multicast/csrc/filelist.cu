...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _989_archive_1.so
_989_archive_1.so : archive.2/_989_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -o .//../simv.daidir//_989_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_989_archive_1.so $@

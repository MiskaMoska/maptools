...
from ppq import QuantableOperation, Variable, TensorQuantizationConfig
...
def save_quantization(
    ...
    for op in graph.operations.values():
        ...
        if isinstance(op, QuantableOperation) and op._type in ACTIVE_OPTYPE:
            ...
            config_kwargs['input_scale'] = int(input_config.scale)
            config_kwargs['output_bits'] = int(output_config.num_of_bits)
            config_kwargs['output_scale'] = int(output_config.scale)
